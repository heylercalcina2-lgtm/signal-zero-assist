...
const CARDS = [
  ...
  { key: "atrapada", icon: Users, to: null },
  { key: "quemadura", icon: Flame, to: null },
  { key: "convulsion", icon: Zap, to: null },
] as const;
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-xl flex-col px-5 pb-32 pt-6">
      <div className="flex justify-center">
        <div className="flex items-center gap-2 rounded-2xl border border-border bg-card px-4 py-2 text-sm font-semibold tracking-wide text-confirm">
